 ...
 *   - Relay fallback: GET /Safecloud/cloud/relay/{rootCid}?link=track/data/...
 *   - CoC gossip over hyperswarm Noise connections
 *   - Request coalescing and CID-level deduplication
 *
 * Replace Q.Safecloud.Router before calling Q.Safecloud.listen() to plug in a
 ...
 */
Q.Safecloud.listen = function (options) {
